# pyTR GUI: Use TradeRepublic in terminal with a gui (deprecated: i will not continue to work on this anymore due to several other projects and real life workload)
